...
example_test = """
#[cfg(test)]  // This ensures the test module is only compiled when running tests
mod tests {
    use super::*;  // Import the function from the parent scope (main module)

    #[test]  // Marks this function as a test
    fn test_factorial() {
        // Common test cases:
        
        // Check the factorial of 0 (edge case)
        assert_eq!(factorial(0), 1);

        // Check the factorial of a small number
        assert_eq!(factorial(5), 120);

        // Check the factorial of a larger number
